...
\begin{abstract}
   % The text for your abstract goes here. The abstract should summarise the paper and be no more than about 150 words
...
% The background section you help the reader understand the type of classifier that you use in your system.
% - Provide a brief description of the general principles.
% - Provide some references to point the reader to where they can learn more.
% - Explain the key hyperparameters that need to be tuned.
...
%
% You can also analyse the performance. For example, you may want to include confusion matrices. Or you may want to look as cases where it fails to see if you can understand why.
